    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        S = function (t) {
          ...
          for (e = 0; e < R.length; e++)
            if ((n = R[e] + i) in C.style) return { dom: n, css: T[e] + t };
        },
        z = (e.support = {
      ...
      var D = (e.frame = (function () {
        ...
        j = l(function (e) {
          ...
          (e.init = function (e) {
            ...
            z.backface &&
              U.hideBackface &&
              G(this.el, z.backface.css, "hidden");
          }),
            b("add", r),
            b("start", o),
            b("wait", function (t) {
        ...
        W = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (D(n), e = P(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      (e.fallback = function (t) {
        if (!z.transition) return (U.fallback = !0);
        U.agentTests.push("(" + t + ")");
        ...
        function $(t, e) {
          if (!t.open) {
            ...
            if (
              ...
              var d = u + o;
              l(t.menu).add(f).set({ y: -d }).start({ y: 0 }).then(p);
            }
          }
          function p() {
